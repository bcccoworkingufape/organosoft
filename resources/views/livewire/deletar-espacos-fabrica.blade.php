<div>
    @switch($tipo)
        @case('icon')
            <a wire:click="toggleModal" href="#" title="Deletar espaço da fábrica">
                @switch($cor)
                    @case('white')
    ...
    <x-jet-confirmation-modal wire:model="show">
        ...
        <x-slot name="content">Tem certeja que deseja deletar este espaço da fábrica?</x-slot>
        <x-slot name="footer">
