        ...
        <form id="form" action="{{route('produtores.update', $produtor)}}" method="POST" class="justify-center flex">
            ...
            <x-form class="pt-4 w-2/3 flex flex-wrap">
                ...
                <x-form-control class="w-1/2 pr-4">
                    ...
                    <x-input id="cep" type="text" name="cep" value="{{old('cep', $produtor->endereco->cep)}}"/>
                </x-form-control>
                <x-form-control class="w-1/2 pl-4">
                    <x-label for="bairro" value="Bairro:" />
                    <x-input id="bairro" type="text" name="bairro" value="{{old('bairro', $produtor->endereco->bairro)}}"/>
                </x-form-control>
                <x-form-control class="w-1/2 pr-4">
                    <x-label for="rua" value="Rua:" />
                    <x-input id="rua" type="text" name="rua" value="{{old('rua', $produtor->endereco->rua)}}"/>
                </x-form-control>
                <x-form-control class="w-1/2 pl-4">
                ...
                <x-form-control class="w-1/2 pr-4">
                    ...
                    <x-input id="estado" type="text" name="estado" value="{{old('estado', $produtor->endereco->estado)}}"/>
                </x-form-control>
                <x-form-control class="w-1/2 pl-4">
                    <x-label for="cidade" value="Cidade:" />
                    <x-input id="cidade" type="text" name="cidade" value="{{old('cidade', $produtor->endereco->cidade)}}"/>
                </x-form-control>
                <x-form-control class="w-full">
